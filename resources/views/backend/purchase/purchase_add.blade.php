                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add products</h4><br><br>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="md-3">
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    ...
                                    <input name="purchase_no" class="form-control" type="text" id="purchase_no" >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="md-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="supplier_id" class="form-select select2" name="supplier_id" aria-label="Default select example">
